...
#define DRAW_GUI(name) void name(ImGuiIO *io, bool *show_demo_window, bool *show_another_window, ImVec4 *clear_color, \
    U32 *counter, F32 *slider, processor_8086 *processor)
