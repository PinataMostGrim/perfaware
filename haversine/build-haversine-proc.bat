...
set SOURCES=%SCRIPT_FOLDER%src\haversine-processor.c
...
::cl -E %COMPILER_FLAGS% %INCLUDES% %SOURCES% -Fe"%BUILD_FOLDER%\%OUT_EXE%" /link %LINKER_FLAGS% %LIBS% | clang-format -style="Microsoft" > temp.txt
