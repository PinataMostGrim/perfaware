:: Build script for reference_haversine_ranges.c
...
set OUT_EXE=reference_haversine_ranges

set INCLUDES=-I%SCRIPT_FOLDER%..\common\src\ -I%SCRIPT_FOLDER%..\haversine\src\
set SOURCES="%SCRIPT_FOLDER%%SRC_FOLDER%\reference_haversine_ranges.c"
...
IF [%DEBUG%] == [1] (
    :: Making debug build
    set COMPILER_FLAGS=-nologo -Od -Gm- -MT -W4 -FC -wd4996 -wd4201 -wd4100 -wd4505 -wd4127 -Zi -DEBUG:FULL
