# Build script for reference_haversine_comparison.c
...
SRC_FOLDER="src"
BUILD_FOLDER="bin"
OUT_EXE="reference_haversine_comparison"

INCLUDES="-I../../common/src/ -I../../haversine/src/"
SOURCES="$SCRIPT_FOLDER/$SRC_FOLDER/reference_haversine_comparison.c"
LINKER_FLAGS="-lm"
...
# Compile reference_haversine_comparison.c
