# Build script for test_memory_arena.c
...
SRC_FOLDER="src"
BUILD_FOLDER="bin"
OUT_EXE="test_memory_arena"

INCLUDES="-I $SCRIPT_FOLDER/../common/src"
SOURCES="$SCRIPT_FOLDER/$SRC_FOLDER/test_memory_arena.c"
LINKER_FLAGS=""
